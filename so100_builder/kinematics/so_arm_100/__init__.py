...
# root.
#
# 1.3.0 (2026-08-11): added grasp.grasp_offset_for_length() and constants
# JAW_CONTACT_HALF_LENGTH_M/MIN_GRASP_OFFSET_M (D13 -- the grasp offset now
# adapts to short sticks instead of always being GRASP_OFFSET_M).
# STICK_LENGTH_RANGE_M's minimum lowered 0.080 -> 0.050. Every stick long
# enough for the unmodified GRASP_OFFSET_M (today, >= ~56mm) is completely
# unaffected -- grasp_offset_for_length() returns exactly GRASP_OFFSET_M for
# those, same as calling grasp_target()/solve_stick_placement() directly
# always did.
